...
* Description    : CH554时钟选择和配置函数,默认使用内部晶振12MHz，如果定义了FREQ_SYS可以
...
void CH554UART0SendString(UINT8 *Str)
{
	while(*Str!=0)
	{
